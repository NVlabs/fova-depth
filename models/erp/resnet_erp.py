...
from models.erp.erp_conv import ERPConv2d, ERPConv3d

def replace_layers(model):
    for name, module in model.named_children():
        if isinstance(module, nn.Conv2d):
            new_conv =  ERPConv2d(module.in_channels, module.out_channels, module.kernel_size, 
                                             module.stride, module.padding[0], module.dilation, 
